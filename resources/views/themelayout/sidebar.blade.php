                    ...
                    <div class="sa-sidebar__header">
                        <a class="sa-sidebar__logo" href="#">
                            ...
                            <div class="sa-sidebar-logo">
                                ...
                                <!-- </svg>  -->
                                @if(Auth::user()->role ==1)
                                <div class="sa-sidebar-logo__caption">Clients</div>
                                @endif
                            </div>
                            <!-- logo / end -->
                        </a>
                            ...
                            <li class="sa-nav__section">
                                ...
                                <ul class="sa-nav__menu sa-nav__menu--root">
                                    <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="{{route('client.home')}}" class="sa-nav__link">
                                 ...
                                 <li class="sa-nav__menu-item">
                                  <a href="{{route('Users')}}" class="sa-nav__link">
                                      <span class="sa-nav__menu-item-padding"></span>
                                      <span class="sa-nav__title">Users List<span>
                                     </a>
                                 </li>
                                 <li class="sa-nav__menu-item">
                                     <a href="{{route('Ticket')}}" class="sa-nav__link">
                                         <span class="sa-nav__menu-item-padding"></span>
                                         <span class="sa-nav__title">Client Support <span>
                                        </a>
                                    </li>
                                    @else
                                    <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                       <a href="" class="sa-nav__link" data-sa-collapse-trigger="">
                                           ...
                                           <span class="sa-nav__title">User Support</span>
                                       ...
                                       <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                           <li class="sa-nav__menu-item">
                                               <a href="{{route('Ticket')}}" class="sa-nav__link">
                                                   <span class="sa-nav__menu-item-padding"></span>
                                                   <span class="sa-nav__title">Tickets List</span>
                                               </a>
                                           </li>
                                           <li class="sa-nav__menu-item">
                                               <a href="{{route('add.Ticket')}}" class="sa-nav__link">
                                                   <span class="sa-nav__menu-item-padding"></span>
                                                   <span class="sa-nav__title">Add Ticket</span>
                                               </a>
                                           </li>
